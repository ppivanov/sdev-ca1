    ...
    """),_display_(/*7.6*/form(action=routes.ProjectController.addProjectSubmit(), 'class -> "form-horizontal", 'role -> "form",
        ...
        """),_display_(/*9.10*/CSRF/*9.14*/.formField),format.raw/*9.24*/("""
            ...
            """),format.raw/*19.13*/("""<div class="actions">
                ...
                <a href=""""),_display_(/*21.27*/routes/*21.33*/.HomeController.projects(0)),format.raw/*21.60*/("""">
...
""")))}),format.raw/*26.2*/(""" """))
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  HASH: 4a69eb4931642755a039fe2ecf7aa42f4a43296d
                  MATRIX: 989->1|1125->66|1169->82|1196->84|1228->108|1266->109|1297->114|1366->158|1541->325|1580->327|1616->337|1628->341|1658->351|1712->378|1808->453|1862->480|1973->569|2014->583|2112->660|2153->674|2251->751|2293->766|2378->830|2419->843|2583->980|2598->986|2646->1013|2806->1143|2835->1161|2867->1163
